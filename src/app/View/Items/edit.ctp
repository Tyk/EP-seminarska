...
<?php echo $this->Form->end(__('Submit'));?>
	<div>Images:</div>
	<?php echo $this->Form->create('Image', array('action' => 'add_to_item', 'type' => 'file')); 
	...
	foreach ($item['Image'] as $image):?>
		<div>
			...
			<?php echo $this->Form->postLink('delete', array('controller' => 'images', 'action' => 'delete_from_item', $image['id'],$item['Item']['id'])); ?>
		</div>			
	<?php endforeach; ?>
</div>
